...
func buildAgentManifest(agent model.Agent, cp agentControlPlaneView, now time.Time) agentManifest {
	...
	routes := []agentRouteContract{
		...
		{
			ID:                   "agent.messages.runtime.publish",
			Method:               "POST",
			Path:                 "/v1/runtime/messages/publish",
			Auth:                 "bearer_agent",
			RequestContentTypes:  []string{"application/json"},
			ResponseContentTypes: []string{"application/json"},
			ReadOnly:             false,
			...
			Retryable:            true,
			TrustStateGated:      true,
			Description:          "Generic runtime JSON envelope publish adapter (canonical runtime surface).",
		},
		{
			ID:                   "agent.messages.runtime.pull",
			Method:               "GET",
			Path:                 "/v1/runtime/messages/pull",
			Auth:                 "bearer_agent",
			ResponseContentTypes: []string{"application/json"},
			ReadOnly:             true,
			Mutating:             false,
			Retryable:            true,
			TrustStateGated:      false,
			Description:          "Generic runtime JSON envelope pull adapter with result.envelope projection.",
		},
		{
			ID:                   "agent.messages.runtime.ack",
			Method:               "POST",
			Path:                 "/v1/runtime/messages/ack",
			Auth:                 "bearer_agent",
			RequestContentTypes:  []string{"application/json"},
			ResponseContentTypes: []string{"application/json"},
			ReadOnly:             false,
			...
			Retryable:            true,
			TrustStateGated:      false,
			Description:          "Generic runtime JSON envelope ack adapter.",
		},
		{
			ID:                   "agent.messages.runtime.nack",
			Method:               "POST",
			Path:                 "/v1/runtime/messages/nack",
			Auth:                 "bearer_agent",
			RequestContentTypes:  []string{"application/json"},
			ResponseContentTypes: []string{"application/json"},
			ReadOnly:             false,
			...
			Retryable:            true,
			TrustStateGated:      false,
			Description:          "Generic runtime JSON envelope nack adapter.",
		},
		{
			ID:                   "agent.messages.runtime.status",
			Method:               "GET",
			Path:                 "/v1/runtime/messages/{message_id}",
			Auth:                 "bearer_agent",
			ResponseContentTypes: []string{"application/json"},
			ReadOnly:             true,
			Mutating:             false,
			Retryable:            true,
			TrustStateGated:      false,
			Description:          "Generic runtime JSON envelope status adapter.",
		},
		{
			ID:                   "agent.messages.runtime.ws",
			Method:               "GET",
			Path:                 "/v1/runtime/messages/ws",
			Auth:                 "bearer_agent",
			ResponseContentTypes: []string{"application/json"},
			ReadOnly:             false,
			Mutating:             true,
			Retryable:            true,
			TrustStateGated:      false,
			Description:          "Generic runtime websocket adapter for delivery, command frames, activity, and presence.",
		},
		{
			ID:                   "agent.messages.runtime.offline",
			Method:               "POST",
			Path:                 "/v1/runtime/messages/offline",
			Auth:                 "bearer_agent",
			RequestContentTypes:  []string{"application/json"},
			ResponseContentTypes: []string{"application/json"},
			ReadOnly:             false,
	...
	capabilities := []agentCapabilityContract{
		...
		},
		{
			...
			RouteIDs: []string{
				...
				"agent.messages.runtime.publish",
				"agent.messages.runtime.pull",
				"agent.messages.runtime.ack",
				"agent.messages.runtime.nack",
