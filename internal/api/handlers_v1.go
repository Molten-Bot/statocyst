...
var agentConnectPromptLines = []string{
	...
	"8. If `can_communicate=false`, trust path is not active yet: finish pending agent trust approvals on both sides; when both peers are org-scoped in different orgs, ensure org trust is active too.",
